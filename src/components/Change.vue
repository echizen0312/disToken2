<template>
    <div style="width: 100%; padding: 10px; max-width: 600px; margin: 0 auto;">
        <mu-card
                v-if="!isOver && configObj.netId == '999' && (symbol == 'NXT' || symbol == 'EOS' || symbol == 'THK' || symbol == 'TMP' || symbol == 'RBCT' || symbol == 'RDCT' || symbol == 'SCT')"
        ...
        <mu-card
                v-if="!isOver && configObj.netId == '002' && (symbol == 'NXT' || symbol == 'EOS' || symbol == 'THK' || symbol == 'TMP' || symbol == 'RBCT' || symbol == 'RDCT' || symbol == 'SCT')"
                style="width: 100%; margin-bottom: 10px; text-align: left; position: relative;">
